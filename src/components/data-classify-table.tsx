...
export function DataClassifyTable({
  columns,
  onUpdateColumn,
  onDeleteColumn,
  ndmoOptions,
  duplicateColumnNames,
}: DataClassifyTableProps) {
  if (columns.length === 0) {
    return (
      <p className="text-center text-muted-foreground py-8">
        No columns added yet. Use the AI classification tools to add columns.
      </p>
    );
  }
  ...
  const handleInputChange = (
    id: string,
    field: keyof Omit<ColumnData, "id">,
    value: any
  ) => {
  ...
  return (
    <div className="rounded-md border overflow-x-auto">
      <Table>
        <TableCaption>
          A list of your classified data columns. Edit directly in the table.
        </TableCaption>
        <TableHeader>
          <TableRow>
            <TableHead className="w-[150px] min-w-[150px] sticky left-0 bg-card z-10">
              Column Name
            </TableHead>
            ...
            <TableHead className="text-center w-[90px] min-w-[90px]">
              Actions
            </TableHead>
          </TableRow>
        </TableHeader>
              ...
              >
                ...
                <TableCell className="text-center align-middle">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleInputChange(column.id, "pii", checked)
                    }
                ...
                <TableCell className="text-center align-middle">
                  <Switch
                    checked={column.phi}
                    onCheckedChange={(checked) =>
                      handleInputChange(column.id, "phi", checked)
                    }
                ...
                <TableCell className="text-center align-middle">
                  <Switch
                    checked={column.pfi}
                    onCheckedChange={(checked) =>
                      handleInputChange(column.id, "pfi", checked)
                    }
                ...
                <TableCell className="text-center align-middle">
                  <Switch
                    checked={column.psi}
                    onCheckedChange={(checked) =>
                      handleInputChange(column.id, "psi", checked)
                    }
                ...
                <TableCell className="text-center align-middle">
                  <Switch
                    checked={column.pci}
                    onCheckedChange={(checked) =>
                      handleInputChange(column.id, "pci", checked)
                    }
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          column and its data from your local data and the
                          database.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
